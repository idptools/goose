'''
Function to try to optimize disorder of a sequence while keeping the amino 
acids constant in the order and position within class. Will only swap residues between
classes.
'''
import random
import numpy as np
