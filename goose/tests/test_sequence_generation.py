...
<<<<<<< HEAD
	assert Protein.calc_FCR(seq_len_FCR) == 0.2
=======
...
<<<<<<< HEAD
	assert Protein.calc_NCPR(seq_len_NCPR) == -0.24
=======
...
<<<<<<< HEAD
	assert abs(Protein.calc_mean_hydro(seq_len_hydropathy)-3.1) < parameters.HYDRO_ERROR
=======
...
<<<<<<< HEAD
	assert Protein.calc_FCR(seq_len_ncpr_fcr) == 0.4
	assert Protein.calc_NCPR(seq_len_ncpr_fcr) == -0.2
=======
...
<<<<<<< HEAD
	assert Protein.calc_FCR(seq_len_fcr_hydro) == 0.2
	assert abs(Protein.calc_mean_hydro(seq_len_fcr_hydro)-3.5) < parameters.HYDRO_ERROR
=======
...
<<<<<<< HEAD
	assert Protein.calc_NCPR(seq_len_ncpr_hydro) == -0.2	
	assert abs(Protein.calc_mean_hydro(seq_len_ncpr_hydro)-3.9) < parameters.HYDRO_ERROR
=======
...
<<<<<<< HEAD
	assert Protein.calc_FCR(seq_len_ncpr_fcr_hydro) == 0.3
	assert Protein.calc_NCPR(seq_len_ncpr_fcr_hydro) == -0.2	
	assert abs(Protein.calc_mean_hydro(seq_len_ncpr_fcr_hydro)-2.9) < parameters.HYDRO_ERROR
=======
...
<<<<<<< HEAD
	assert Protein.calc_FCR(seq_len_ncpr_fcr_hydro_kappa) == 0.3
	assert Protein.calc_NCPR(seq_len_ncpr_fcr_hydro_kappa) == -0.2	
	assert abs(Protein.calc_mean_hydro(seq_len_ncpr_fcr_hydro_kappa)-2.95) < parameters.HYDRO_ERROR
	assert abs(pr(seq_len_ncpr_fcr_hydro_kappa).kappa -0.15) < parameters.MAXIMUM_KAPPA_ERROR
=======
...
>>>>>>> origin/sparrow_predictions
	...
	all_generated_seqs = [seq_len, seq_len_FCR, seq_len_NCPR, seq_len_hydropathy, seq_len_ncpr_fcr, seq_len_fcr_hydro, seq_len_ncpr_hydro, seq_len_ncpr_fcr_hydro, seq_len_ncpr_fcr_hydro_kappa]
...
<<<<<<< HEAD
	assert Protein.calc_frac(seq_one_fraction)['K']==0.3
=======
...
<<<<<<< HEAD
	assert Protein.calc_frac(seq_one_fraction_zero)['Q']==0
=======
...
<<<<<<< HEAD
	fracs = Protein.calc_frac(seq_one_fraction_one_not)
=======
...
<<<<<<< HEAD
	fracs = Protein.calc_frac(seq_multiple_zero_fractions)
=======
...
<<<<<<< HEAD
	fracs = Protein.calc_frac(seq_multiple_specified)
=======
...
>>>>>>> origin/sparrow_predictions
	...
	seq_all_fractions = create.seq_fractions(100, A=0.02, C=0.01, D=0.03, E=0.01, F=0.01, G=0.06, H=0.1, I=0.01, K=0.05, L=0.06, M=0.01, N=0.13, P=0.1, Q=0.1, R=0.06, S=0.1, T=0.1, V=0.02, W=0.01, Y=0.01)
	assert len(seq_all_fractions)==100
<<<<<<< HEAD
	fracs = Protein.calc_frac(seq_all_fractions)
=======
...
>>>>>>> origin/sparrow_predictions
	...
	# Finally, verify that the disorder for all sequencs made are within spec.
	all_generated_seqs = [seq_one_fraction, seq_one_fraction_zero, seq_one_fraction_one_not, seq_multiple_zero_fractions, seq_multiple_specified, seq_all_fractions]
	for sequence in all_generated_seqs:
		assert check_disorder(sequence)==True
